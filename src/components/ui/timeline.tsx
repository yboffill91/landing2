    ...
    <div className='w-full bg-slate-950/90 md:px-10' ref={containerRef}>
      <div className='max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10'>
        ...
        <p className=' text-base '>
          You need to break into and impact your niche, achieve high viisibility
          of your brand at golbal level to be able to compete more effectively
          and surpass the comprtition, and in this way generate numerous
          opportunities that are being captured today by others. This is what it
          is for, essential to take a series of strategic steps.
        </p>
      </div>
